#!/usr/bin/env bash
#
# N in-process Piper engines (tts-service/engines/piper), one per port,
...
# every engine call under one lock (tts-service/engines/piper's docstring,
...
BASE_PORT=8898
PROJECT="tts-service/engines/piper"
